<div class="modal-content" id="modal-addVersion">
				...
				<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
					...
					<div class="text-center mb-13">
						<!--begin::Title-->
						<h1 class="mb-3">Добавление PLUnity </h1>
						<!--end::Title-->
					</div>
					<!--end::Heading-->
					<!--begin::Textarea-->
					<div class="add-plunity">
						...
						<div class="item-pl">
							<span>micro</span>
							<input type="text" name="micro" placeholder="micro">
						</div>
						<div class="item-pl">
							<span>releaseNote</span>
							<textarea class="form-control form-control-solid" name="releaseNote" rows="5"></textarea>
						</div>
						<div class="item-pl">
							<span>Платформа</span>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" onclick="addVersion()">Сохранить</button>
				</div>
                    </form>
					<!--end::Modal content-->
				</div>
