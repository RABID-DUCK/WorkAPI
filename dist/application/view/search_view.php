												...
												<tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php 
                                                            ...
                                                            if(isset($value)){
                                                                $obj = new Layout();
                                                                $data = $obj->GetLastVersion($value);
                                                                echo $value;
                                                            }
                                                            else{
                                                                echo "Данных с таким id нет :(";
                                                            }
                                                            ?>
                                                            
                                                        </td>
                                                        <td class="text-dark fw-bolder text-hover-primary fs-6">
                                                        <? echo $data['payload']['major'] ?>.
                                                            <? echo $data['payload']['minor'] ?>.
                                                            <? echo $data['payload']['micro'] ?>

                                                        </td>
                                                        <td class="text-dark fw-bolder text-hover-primary fs-6">
                                                        <? echo $data['payload']['releaseNote'] ?>
                                                        </td>
                                                        <td>
